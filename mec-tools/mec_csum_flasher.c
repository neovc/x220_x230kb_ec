...
int main(int argc, char *argv[])
{
    ...
    for (p = base; p < end-4; p++)
        csum = crc16_table[(csum>>8)^(*p)] ^ (csum<<8);

    /* NOTE: this applies to checksum of firmware image; if trying to use
     * this code for the flasher itself, that checksum is byte swapped */
